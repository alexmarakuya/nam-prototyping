              ...
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
                ...
                <div className="p-3 bg-blue-50 border-b border-blue-200 rounded-t-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-blue-800">Draft Response</span>
                    <span className="text-sm text-blue-700">AI-generated response ready for review</span>
                    <div className="ml-auto flex gap-2">
                      <button className="text-sm text-blue-600 hover:text-blue-800">Edit</button>
                      <button className="text-sm text-blue-600 hover:text-blue-800">Send</button>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 bg-purple-600 rounded-lg flex items-center justify-center text-white text-sm font-medium flex-shrink-0">AT</div>
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="font-medium text-gray-900">Acai Travel Support</span>
                        <span className="text-sm text-gray-500">To: kartik.kapgate@email.com</span>
                        <span className="text-xs text-gray-400 ml-auto">Draft • Aug 18, 3:58 PM</span>
                        <button className="p-1 hover:bg-gray-100 rounded">
                          <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                          </svg>
                      ...
                      <div className="text-gray-900 mb-4">
                        <p className="mb-2">Hi Kartik,</p>
                        <p className="mb-2">Thanks for contacting Acai Travel.</p>
                        <p className="mb-2">Here is the baggage policy for your booking (PNR: C7Q3SR) with Iberia:</p>
                        <p className="mb-2"><strong>Carry-On Baggage:</strong> 1 cabin bag (max size 56x40x25 cm, max weight 10 kg) and 1 personal accessory (max size 30x40x15 cm).</p>
                        <p className="mb-2"><strong>Checked Baggage:</strong> Economy Class typically includes 1 piece (max weight 23 kg, max dimensions 158 cm total).</p>
                        <p>Let me know if you have any further questions or need assistance.</p>
                      </div>
                      <div className="border-t border-gray-200 pt-3">
                        <div className="text-sm text-gray-900 font-medium">—</div>
                        <div className="text-sm text-gray-900 font-medium">Acai Travel Virtual Agent</div>
                        <div className="text-sm text-gray-500 mt-2">Generated by <span className="font-medium text-gray-900">Acai AI</span></div>
                      </div>
                    </div>
                  </div>
                </div>
